...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/h3pandas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13248&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/h3pandas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `h3pandas` can be installed with:

```
conda install h3pandas
```

It is possible to list all of the versions of `h3pandas` available on your platform with:
